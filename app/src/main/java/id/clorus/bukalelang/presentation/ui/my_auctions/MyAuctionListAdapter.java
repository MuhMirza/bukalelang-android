 ...
 */
public class MyAuctionListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static String LOG_TAG = "ProductListAdapter";
    private ArrayList<MyAuction> mDataset;
    ...
    private MyAucionView mView;

    public MyAuctionListAdapter(Context context, ArrayList<MyAuction> mDataset, MyAucionView view) {
    ...
    public MyAuctionListAdapter(ArrayList<MyAuction> myDataset) {
        mDataset = myDataset;
    }
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (mDataset.get(holder.getAdapterPosition()).getIsRunning() == 1 ){
    ...
    public void addItem(MyAuction dataObj, int index) {
    ...
    // Add a list of items
    public void addAll(ArrayList<MyAuction> list) {
