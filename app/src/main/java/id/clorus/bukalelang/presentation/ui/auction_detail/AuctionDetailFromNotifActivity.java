...
public class AuctionDetailFromNotifActivity extends DefaultActivity implements AuctionDetailView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null){
            searchBySLug(bundle.getString("slug"));
        }


    }

    public void searchBySLug(String slug){

            RestService.Factory.getInstance().getItemAuctionBySlug("auctions/slug/"+slug).enqueue(new Callback<Auction>() {
                @Override
...
//            btnOpenBidMenu.setVisibility(View.GONE);
            ...
            if (data.getIsCheckedOut() == 0){
                ...
                btnOpenBidMenu.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(AuctionDetailFromNotifActivity.this, CheckoutActivity.class);
    ...
    public void bid(){
        ...
        if (!appPreference.loggedIn()){
            Intent intent = new Intent(AuctionDetailFromNotifActivity.this, AuthActivity.class);
            startActivity(intent);
            finish();
        }
