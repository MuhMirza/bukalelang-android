 ...
 */
public class SearchAuctionListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchAuctionListAdapter(Context context, ArrayList<Auction> mDataset, HomeView view) {
    ...
    public SearchAuctionListAdapter(ArrayList<Auction> myDataset) {
        mDataset = myDataset;
    }
